        ...
        tabs: [
            {
                ...
                // 模板
                tpl: `<div>
                  <iframe id="${inputIFrameId}" class="iframe" height="500px" width="100%" frameborder="0" scrolling="no" src="${process.env.BASE_URL}kityformula/index.html"></iframe>
                ...
                events: [
                    {
                        ...
                        fn: () => {
                            ...
                            editor.txt.append('<img class="formula" src="https://latex.codecogs.com/gif.latex?' + latex + '" data-latex="' + latex + '" />');
